...
for howManyC = 1:6
    for whichSeed = 1:10
        fprintf('\n%d %d\n',howManyC,whichSeed)
        load(sprintf('C:/Users/eyeze/Documents/GradSchool/JohnsHopkinsStudent/CharlesLab/backup_dLDSDiscreteBehavior/dLDS-Discrete-Matlab-Model_FishBehavior/code/TMLR/saveFMT_260303_seed%02d_TMLR_b1_c%d.mat',whichSeed,howManyC))
...
for howManyC = 1:6
    for whichSeed = 1:10
        fprintf('\n%d %d\n',howManyC,whichSeed)
        load(sprintf('C:/Users/eyeze/Documents/GradSchool/JohnsHopkinsStudent/CharlesLab/backup_dLDSDiscreteBehavior/dLDS-Discrete-Matlab-Model_FishBehavior/code/TMLR10bhv/saveFMT_260303_seed%02d_TMLR_b10_c%d.mat',whichSeed,howManyC))
