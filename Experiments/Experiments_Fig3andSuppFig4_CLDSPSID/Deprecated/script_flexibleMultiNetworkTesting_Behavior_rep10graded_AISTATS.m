...
save(sprintf('saveFMT_%d_seed01_AISTATS_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState02 = rng;
%%
...
save(sprintf('saveFMT_%d_seed02_AISTATS_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState03 = rng;
%%
...
save(sprintf('saveFMT_%d_seed03_AISTATS_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState04 = rng;
sizeD            = 8;
...
save(sprintf('saveFMT_%d_seed04_AISTATS_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState05 = rng;
%%
...
save(sprintf('saveFMT_%d_seed05_AISTATS_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState06 = rng;
%%
...
save(sprintf('saveFMT_%d_seed06_AISTATS_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState07 = rng;
%%
...
save(sprintf('saveFMT_%d_seed07_AISTATS_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState08 = rng;
%%
...
save(sprintf('saveFMT_%d_seed08_AISTATS_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState09 = rng;
%%
...
save(sprintf('saveFMT_%d_seed09_AISTATS_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState10 = rng;
%%
...
save(sprintf('saveFMT_%d_seed10_AISTATS_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))