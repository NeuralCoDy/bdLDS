...
save(sprintf('saveFMT_%d_seed01_AblSprPsi_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState02 = rng;
%%
...
save(sprintf('saveFMT_%d_seed02_AblSprPsi_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState03 = rng;
%%
...
save(sprintf('saveFMT_%d_seed03_AblSprPsi_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState04 = rng;
sizeD            = 8;
...
save(sprintf('saveFMT_%d_seed04_AblSprPsi_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState05 = rng;
%%
...
save(sprintf('saveFMT_%d_seed05_AblSprPsi_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState06 = rng;
%%
...
save(sprintf('saveFMT_%d_seed06_AblSprPsi_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState07 = rng;
%%
...
save(sprintf('saveFMT_%d_seed07_AblSprPsi_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState08 = rng;
%%
...
save(sprintf('saveFMT_%d_seed08_AblSprPsi_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState09 = rng;
%%
...
save(sprintf('saveFMT_%d_seed09_AblSprPsi_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))
%%
rng('shuffle')
currentState10 = rng;
%%
...
save(sprintf('saveFMT_%d_seed10_AblSprPsi_b%d_c%d.mat',todaysDate,nBhv,howManyColsPhi))