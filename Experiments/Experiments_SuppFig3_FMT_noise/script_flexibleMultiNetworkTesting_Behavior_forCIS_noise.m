...
% A(2:end,:) = 0;
A(:,2:end) = 0; % first three coefficients are related to behavior
...
noiseLevelLambdaRescale = noiseLevel^2;
...
% inf_opts.lambda_b        = inf_opts.lambda_b*(1+1 / (1 + e^((-1)*noiseLevelLambdaRescale)));
...
% inf_opts.lambda_historyb = inf_opts.lambda_historyb*(1+1 / (1 + e^((-1)*noiseLevelLambdaRescale)));
...
% inf_opts.lambda_f        = inf_opts.lambda_f+10*(1+1 / (1 + e^((-1)*noiseLevelLambdaRescale)));
