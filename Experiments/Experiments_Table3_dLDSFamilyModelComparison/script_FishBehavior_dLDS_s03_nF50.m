...
inf_opts.behaviordLDS    = 0;
inf_opts.lambda_behavior = 0;
inf_opts.nBhv            = 0;
inf_opts.verysparsebhv   = 0;

inf_opts.nF = 50;

% % BayesOpt - neural R^2 - all cs 0
% inf_opts.lambda_val      = 0.0399;
% inf_opts.lambda_history  = 0.4459;
% inf_opts.lambda_b        = 0.5689;
...
%%
save(sprintf('saveFish_En_%s_dLDSonly_s03_nF50.mat',todaysDate),'-v7.3');
