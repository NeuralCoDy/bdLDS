...
if inf_opts.behaviordLDS
    [Phi, F, Psi] = bpdndf_dynamics_learning_behavior_x(dFF2, [], [], [], behavior2, inf_opts);              % Run the dictionary learning algorithm
else
...
save('saveFMT_1bhvgraded_forCLDS_TMLR_BtoX.mat')