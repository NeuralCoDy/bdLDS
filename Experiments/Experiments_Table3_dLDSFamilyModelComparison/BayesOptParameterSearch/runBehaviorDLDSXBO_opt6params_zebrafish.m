function objectiveToMinimize = runBehaviorDLDSXBO_opt6params_zebrafish(dFF,behavior_data,...
    lambda_val,lambda_history,lambda_b,lambda_behavior,step_psi,lambda2,inf_opts)

disp('optimize for behavior R2')
disp('minimize 1-R^2')

% inf_opts.lambda_D = 0; % in main script
inf_opts.lambda_val = lambda_val;
inf_opts.lambda_history  = lambda_history;
inf_opts.lambda_b = lambda_b;
inf_opts.lambda_behavior  = lambda_behavior;
inf_opts.step_psi = step_psi;
inf_opts.lambda2  = lambda2;
%%
tic
