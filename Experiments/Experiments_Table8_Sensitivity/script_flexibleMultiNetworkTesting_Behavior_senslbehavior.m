...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
lambdaBehaviorSetting = [0.1 0.1 0.1 0.101 0.101 0.101 0.11 0.11 0.11 0.2 0.2 0.2 1.1 1.1 1.1];
for lambdaBehaviorSettingIdx = 1:15
    modelPerformance(lambdaBehaviorSettingIdx,1) = lambdaBehaviorSetting(lambdaBehaviorSettingIdx);
    [modelPerformance(lambdaBehaviorSettingIdx,2), modelPerformance(lambdaBehaviorSettingIdx,3), modelPerformance(lambdaBehaviorSettingIdx,4)] = ...
        runBDLDSonSimlbhv(lambdaBehaviorSetting(lambdaBehaviorSettingIdx));
end
save('SensitivityExperiment_Sim_lambdaBehavior.mat')

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [medianDynCoefUseOneRun,varExplBhv,varExpl] = runBDLDSonSimlbhv(lambda_behavior)
nBhv = 1;
howManyColsPhi = 1;
noiseLevel = 0;
