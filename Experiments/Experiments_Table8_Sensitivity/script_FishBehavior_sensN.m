...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
nSetting = [25 25 25 35 35 35 45 45 45 50 50 50 55 55 55];
disp('new')
for nSettingIdx = 1:15
    modelPerformance(nSettingIdx,1) = nSetting(nSettingIdx);
    [modelPerformance(nSettingIdx,2), modelPerformance(nSettingIdx,3),modelPerformance(nSettingIdx,4)] = ...
        runBDLDSonZebrafish(nSetting(nSettingIdx));
end
save('SensitivityExperiment_FishBehavior_sensN.mat')

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [medianDynCoefUseOneRun,varExplBhv,varExpl] = runBDLDSonZebrafish(N)
