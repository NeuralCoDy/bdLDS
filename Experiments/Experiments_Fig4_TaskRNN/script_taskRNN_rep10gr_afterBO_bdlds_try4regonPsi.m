...
reconstructedBehavior = Psi*B_cell{1}; % for b-dLDS
...
% stdPsi = std(Psi(:))
%%
save(sprintf('saveTaskRNN_Psiregbdlds_%s_s01.mat',todaysDate))
%% check outputs
% figure()
% tiledlayout('vertical')
% nexttile()
...
save(sprintf('saveTaskRNN_Psiregbdlds_%s_s02.mat',todaysDate))
...
save(sprintf('saveTaskRNN_Psiregbdlds_%s_s03.mat',todaysDate))
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
rng('shuffle')
currentState04 = rng;
...
save(sprintf('saveTaskRNN_Psiregbdlds_%s_s04.mat',todaysDate))
