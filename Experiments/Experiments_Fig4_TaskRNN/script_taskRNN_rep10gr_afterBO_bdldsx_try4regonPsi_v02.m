...
inf_opts.lambda_val      = 0.1526;         % ASC added 7/25 % VARY - tradeoff: approx. SNR - see ratios of traces % 0.0001 (don't shrink this further - gets to be essentially 0 for solver_L1RLS)
inf_opts.lambda_history  = 0.0191; % set from 500 iters BO %0.1;%0.01;         % ASC added 7/25
inf_opts.lambda_b        = 0.0316;%0.25; %0.5;%0.39;           % ASC added 7/25 %0.025 % 0.5 %0.6
...
if inf_opts.behaviordLDS == 1
    inf_opts.step_psi        = 20; %input('step_psi:');%1; 
    ...
    inf_opts.lambda2         = 0.9644;%3.4531; %input('lambda2:');
...
% stdPsi = std(Psi(:))
%%
save(sprintf('saveTaskRNN_Psireg_%s_s01.mat',todaysDate))
%% check outputs
% figure()
% tiledlayout('vertical')
% nexttile()
% plot(dFF{1}.');ylabel('activity')
% nexttile()
% plot(behaviorData{1}.');ylabel('bhv')
% nexttile()
% plot(A_cell{1}.');ylabel('x')
% nexttile()
% plot(B_cell{1}.');ylabel('c')
% nexttile()
% plot((Psi*A_cell{1}).');ylabel('Psi*c')
...
save(sprintf('saveTaskRNN_Psireg_%s_s02.mat',todaysDate))
...
save(sprintf('saveTaskRNN_Psireg_%s_s03.mat',todaysDate))
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
rng('shuffle')
currentState04 = rng;
...
save(sprintf('saveTaskRNN_Psireg_%s_s04.mat',todaysDate))
...
save(sprintf('saveTaskRNN_Psireg_%s_s05.mat',todaysDate))
