...
if inf_opts.behaviordLDS == 1
    inf_opts.step_psi        = 17; %input('step_psi:');%1; 
...
% stdPsi = std(Psi(:))
%%
save(sprintf('saveTaskRNN_afterBO_%s_s01.mat',todaysDate))
%% check outputs
% figure()
% tiledlayout('vertical')
% nexttile()
...
save(sprintf('saveTaskRNN_afterBO_%s_s02.mat',todaysDate))
...
save(sprintf('saveTaskRNN_afterBO_%s_s03.mat',todaysDate))
...
rval = corrcoef(allbhv(:), reconstructedBehavior(:));
varExplBhv = (rval(1,2))^2;
save(sprintf('saveTaskRNN_afterBO_%s_s04.mat',todaysDate))
...
save(sprintf('saveTaskRNN_afterBO_%s_s05.mat',todaysDate))
...
save(sprintf('saveTaskRNN_afterBO_%s_s06.mat',todaysDate))
...
save(sprintf('saveTaskRNN_afterBO_%s_s07.mat',todaysDate))
...
save(sprintf('saveTaskRNN_afterBO_%s_s08.mat',todaysDate))
...
save(sprintf('saveTaskRNN_afterBO_%s_s09.mat',todaysDate))
...
save(sprintf('saveTaskRNN_afterBO_%s_s10.mat',todaysDate))
